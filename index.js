...
client.login('NjAxMDQ1Njc1MTUyNzY5MDI1.XTC1Wg.uUM7f2qUdqhS7HCrHCkS2TDRxxE')
...
client.on('guildMemberAdd', function (member) {
    ...
    member.guild.channels.get('600317916868509706').send(embed)
    member.addRole('600340324883234837')
})
...
client.on('guildMemberRemove', function (member) {
    let embed = new Discord.RichEmbed()
        ...
        .setFooter('Nous sommes désormais ' + member.guild.memberCount)
    member.guild.channels.get('600343142704611349').send(embed)
})
...
/*Bienvenue Aurevoir Aleatoire*/
module.exports = async (client, member, args) => {600317916868509706
    ...
    const sayArray = [600317916868509706
...
client.on('message', function (message) {
    if (message.content === "?help") {
        message.channel.sendMessage('Pour faire toutes commande il souvi de faire un *?* Comme commande nous avons pour l instant ban,kick,mute,clear :heart:')
